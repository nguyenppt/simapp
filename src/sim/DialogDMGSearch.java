 ...
 * <p>Description: Main -> Inv Mgmt -> Transfer ->Search </p>
...
//----------------------------------------------------------------------------------------------//
  ...
  public DialogDMGSearch(Frame frame, String title, boolean modal,FrameMainSim frmMain, PickListBusObj plBusObj) {
    ...
    this.addKeyListener(new DialogDMGSearch_this_keyAdapter(this));
    this.addWindowListener(new DialogDMGSearch_this_windowAdapter(this));
    ...
    txtRowLimit.addKeyListener(new DialogDMGSearch_txtRowLimit_keyAdapter(this));
...
//    txtToDate.addKeyListener(new DialogDMGSearch_txtToDate_keyAdapter(this));
    ...
    btnToDate.addActionListener(new
                                   DialogDMGSearch_btnToDate_actionAdapter(this));
    ...
    btnUPC.setText("...");
//    btnUPC.addActionListener(new DialogDMGSearch_btnStore_actionAdapter(this));
    ...
    btnFromDate.setText("...");
    btnFromDate.addActionListener(new DialogDMGSearch_btnFromDate_actionAdapter(this));
    ...
    cboCreator.addKeyListener(new DialogDMGSearch_cboCreator_keyAdapter(this));
    ...
    btnDone.addActionListener(new DialogDMGSearch_btnDone_actionAdapter(this));
    ...
    btnSearch.addActionListener(new
                                DialogDMGSearch_btnSearch_actionAdapter(this));
    ...
    btnDelete.addActionListener(new
                                DialogDMGSearch_btnDelete_actionAdapter(this));
    ...
    btnCancel.addActionListener(new
                                DialogDMGSearch_btnCancel_actionAdapter(this));
    ...
    cboSupp.setMaximumSize(new Dimension(50, 16));
    ...
    jLabel1.setBounds(new Rectangle(36, 84, 73, 24));
    ...
    btnSupp.setMaximumSize(new Dimension(50, 16));
    btnSupp.setText("...");
...
//    pnlHeader.add(btnDelete);
    ...
    table.addMouseListener(new DialogDMGSearch_table_mouseAdapter(this));
//    table.addKeyListener(new DialogDMGSearch_table_keyAdapter(this));
...
//set data into combobox creator
    private void setCboCreator(BJComboBox cbo){
      ...
      String SQL = "SELECT DISTINCT e.EMP_ID, e.EMP_CDE "
          + "FROM BTM_IM_EMPLOYEE e, BTM_IM_DAMAGE d "
...
// action performing of button Cancel
     ...
     void btnSearch_actionPerformed(ActionEvent e) {
       ...
       if (!txtFromDate.getText().equalsIgnoreCase("") && !txtToDate.getText().equalsIgnoreCase("")){
         if (ut.compareDate(txtFromDate.getText(), txtToDate.getText())) {
           ut.showMessage(frmMain, lang.getString("TT001"),lang.getString("MS1022_FromDateBeforeToDate"));
           return;
         }
       }
    ...
    void searchData(int rowsNum) {
      ...
      table.setHeaderName(lang.getString("DMGID"), COL_DMG_ID);
      table.setHeaderName(lang.getString("Description"), COL_DESC);
      table.setHeaderName(lang.getString("DMGFrom"), COL_TYPE);
      table.setHeaderName(lang.getString("CreateDate"), COL_CREATE_DATE);
      table.setHeaderName(lang.getString("TransferDate"), COL_TRANSFER_DATE);
     ...
     private ResultSet getData(int rows, Statement stmt) {
       ...
       try {
         String SQL1 =
             " SELECT * FROM ( "
             + "  SELECT DISTINCT RTV.DMG_ID, RTV.REASON, "
             + "         DECODE(RTV.DMG_TYPE,'F','FrontRoom','B', 'BackRoom')  TYPE, "
             + "         to_char(RTV.CREATED_DATE,'dd/MM/yyyy') CREATE_DATE, "
             + "         to_char(RTV.TRANSFER_DATE,'dd/MM/yyyy') TRANSFER_DATE, "
             + "         DECODE(RTV.STATUS_IND,'W','WorkSheet','A','Approved','C','Completed','Cancelled') STATUS "
             + "         ,EMP_CDE  "
             + "  FROM   BTM_IM_DAMAGE RTV 	  "
             + " 	 ,BTM_IM_EMPLOYEE EMP " ;
         String SQL2 = " ,BTM_IM_DAMAGE_DETAIL DMGDT " ;
         String SQL3 = " WHERE RTV.EMP_ID=EMP.EMP_ID ";
         String SQL4 = " and RTV.DMG_ID = DMGDT .DMG_ID ";

         if (!txtUPC.getText().equals("")){
           SQL = SQL1 + SQL2 + SQL3+ SQL4 ;
           SQL += " and DMGDT.ITEM_ID = '"+getItemId(txtUPC.getText())+"'";
         }
         else{
           SQL = SQL1 + SQL3;
         }
         ...
         if(!cboType.getSelectedItem().toString().equalsIgnoreCase("All")){
            SQL += " and RTV.DMG_TYPE = '" + cboType.getSelectedItem().toString().substring(0,1) + "'";
         }
...
//         System.out.println(SQL);
    ...
    void table_mouseClicked(MouseEvent e) {
      if (e.getClickCount() == 2) {
        if (this.table.getSelectedRow() >= 0) {
          String DGMID = table.getValueAt(table.getSelectedRow(),COL_DMG_ID).toString();
          frmMain.pnlDMGModify.showDataOnForm(DGMID);
          frmMain.pnlDMGModify.initFormValue(frmMain.pnlDMGModify.flagStatus);
          done = true;
          this.dispose();
        }
      }
    ...
    public String getRTVID(){
      ...
      if(table.getSelectedRow()!=-1){
        RTVID=table.getValueAt(table.getSelectedRow(),COL_DMG_ID).toString();
      }
      return RTVID;
    }
...
class DialogDMGSearch_btnDone_actionAdapter
    implements java.awt.event.ActionListener {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_btnDone_actionAdapter(DialogDMGSearch adaptee) {
...
class DialogDMGSearch_btnSearch_actionAdapter
    implements java.awt.event.ActionListener {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_btnSearch_actionAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_btnDelete_actionAdapter
    implements java.awt.event.ActionListener {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_btnDelete_actionAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_btnCancel_actionAdapter
    implements java.awt.event.ActionListener {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_btnCancel_actionAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_cboCreator_keyAdapter
    extends KeyAdapter {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_cboCreator_keyAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_btnToDate_actionAdapter
    implements java.awt.event.ActionListener {
  private DialogDMGSearch adaptee;
  DialogDMGSearch_btnToDate_actionAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_txtRowLimit_keyAdapter extends java.awt.event.KeyAdapter {
    DialogDMGSearch adaptee;

    DialogDMGSearch_txtRowLimit_keyAdapter(DialogDMGSearch adaptee) {
        this.adaptee = adaptee;
    }
...
class DialogDMGSearch_table_mouseAdapter extends java.awt.event.MouseAdapter {
  DialogDMGSearch adaptee;

  DialogDMGSearch_table_mouseAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_this_windowAdapter extends java.awt.event.WindowAdapter {
  DialogDMGSearch adaptee;

  DialogDMGSearch_this_windowAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
...
class DialogDMGSearch_this_keyAdapter extends java.awt.event.KeyAdapter {
  DialogDMGSearch adaptee;

  DialogDMGSearch_this_keyAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
  public void keyPressed(KeyEvent e) {
...
class DialogDMGSearch_btnFromDate_actionAdapter implements java.awt.event.ActionListener {
  DialogDMGSearch adaptee;

  DialogDMGSearch_btnFromDate_actionAdapter(DialogDMGSearch adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
