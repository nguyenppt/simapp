...
/**
 * <p>Title: </p>
 * <p>Description: Main -> Inv Mgmt -> Receive -> From Store -> View Detail</p>
...
public class PanelReceiptFromStoreViewDetail extends JPanel{
...
//  BJComboBox cboStatus = new BJComboBox();
  ...
  public PanelReceiptFromStoreViewDetail(FrameMainSim frmMain) {
    try {
  ...
  private void jbInit() throws Exception {
    ...
    "bsp;&nbsp;&nbsp;&nbsp;&nbsp;&" + "nbsp;F12</html>");
    btnCancel.addActionListener(new PanelReceiptFromStoreViewDetail_btnCancel_actionAdapter(this));
    //Button Print
    ...
    btnPrint.setText("<html><center><b>"+lang.getString("Print")+" </b></center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                      "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;F9</h" +
                      "tml>");
    btnPrint.addActionListener(new PanelReceiptFromStoreViewDetail_btnPrint_actionAdapter(this));
...
//    txtFromStoreID.setFont(new java.awt.Font(lang.getString("FontName_Label"), 1, 12));
    ...
    jLabel6.setText(lang.getString("ReceiptID") + ":");
...
//    txtToStoreID.setText("");
    table.addMouseListener(new PanelReceiptFromStoreViewDetail_table_mouseAdapter(this));
    table.addKeyListener(new PanelReceiptFromStoreViewDetail_table_keyAdapter(this));
    ...
    //Yen.dinh 14-6-2006
    txtUPC.addFocusListener(new PanelReceiptFromStoreViewDetail_txtUPC_focusAdapter(this));
    txtUPC.addKeyListener(new PanelReceiptFromStoreViewDetail_txtUPC_keyAdapter(this));
    ...
    btnSearchItem.addActionListener(new PanelReceiptFromStoreViewDetail_btnSearchItem_actionAdapter(this));
...
//    cboStatus.setFont(new java.awt.Font(lang.getString("FontName_Label"), 1, 12));
    ...
    txtQuantity.setText("");
    txtQuantity.addKeyListener(new PanelReceiptFromStoreViewDetail_txtQuantity_keyAdapter(this));
    txtQuantity.addFocusListener(new PanelReceiptFromStoreViewDetail_txtQuantity_focusAdapter(this));
    ...
    btnDone.addActionListener(new PanelReceiptFromStoreViewDetail_btnDone_actionAdapter(this));
    ...
    btnAdd.addActionListener(new PanelReceiptFromStoreViewDetail_btnAdd_actionAdapter(this));
    ...
    btnDelete.addActionListener(new
                                PanelReceiptFromStoreViewDetail_btnDelete_actionAdapter(this));
  ...
  void txtUPC_keyTyped(KeyEvent e) {
    ...
    if (ut.isIntString("" + key) || key == KeyEvent.VK_BACK_SPACE || key == KeyEvent.VK_DELETE){
      ...
      if (!checkItem(txtUPC.getText().trim(),Long.parseLong(cboSourceStoreID.getSelectedData()))){
        ut.showMessage(frmMain,lang.getString("TT001"),lang.getString("MS348_ItemNotExist"));
        txtUPC.setText("");
        txtUPC.requestFocus(true);
        return;
      }
...
class PanelReceiptFromStoreViewDetail_btnDelete_actionAdapter
    implements java.awt.event.ActionListener {
  private PanelReceiptFromStoreViewDetail adaptee;
  PanelReceiptFromStoreViewDetail_btnDelete_actionAdapter(PanelReceiptFromStoreViewDetail
                                                  adaptee) {
...
class PanelReceiptFromStoreViewDetail_btnCancel_actionAdapter implements java.awt.event.ActionListener {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_btnCancel_actionAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class PanelReceiptFromStoreViewDetail_table_mouseAdapter extends java.awt.event.MouseAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_table_mouseAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReceiptFromStoreViewDetail_btnPrint_actionAdapter implements java.awt.event.ActionListener {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_btnPrint_actionAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class PanelReceiptFromStoreViewDetail_table_keyAdapter extends java.awt.event.KeyAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_table_keyAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReceiptFromStoreViewDetail_txtUPC_keyAdapter extends java.awt.event.KeyAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_txtUPC_keyAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReceiptFromStoreViewDetail_txtUPC_focusAdapter extends java.awt.event.FocusAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_txtUPC_focusAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
...
//------
class PanelReceiptFromStoreViewDetail_txtQuantity_keyAdapter extends java.awt.event.KeyAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_txtQuantity_keyAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void keyTyped(KeyEvent e) {
...
class PanelReceiptFromStoreViewDetail_btnSearchItem_actionAdapter implements java.awt.event.ActionListener {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_btnSearchItem_actionAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
//Yen.Dinh 14-06-2006
class PanelReceiptFromStoreViewDetail_txtQuantity_focusAdapter extends java.awt.event.FocusAdapter {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_txtQuantity_focusAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void focusLost(FocusEvent e) {
...
class PanelReceiptFromStoreViewDetail_btnAdd_actionAdapter implements java.awt.event.ActionListener {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_btnAdd_actionAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class PanelReceiptFromStoreViewDetail_btnDone_actionAdapter implements java.awt.event.ActionListener {
  PanelReceiptFromStoreViewDetail adaptee;

  PanelReceiptFromStoreViewDetail_btnDone_actionAdapter(PanelReceiptFromStoreViewDetail adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
