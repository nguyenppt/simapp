...
public class PanelPrintTransferSim implements Printable{
  ////////////////////////////////////////////
  ...
  public PanelPrintTransferSim(FrameMainSim frmMain) {
...
//System.out.println("VC " + vc.size());
    ...
    int quantity=0;
    ResultSet rs = null;
//    System.out.println("pnlTransfer table " + frmMain.pnlTransfer.table.getRowCount());
    for (int i = 0; i < frmMain.pnlTransfer.table.getRowCount(); i++) {
//          item = (Item) vc.elementAt(i);
      ArtNo = frmMain.pnlTransfer.table.getValueAt(i,1).toString();
      ItemID = frmMain.pnlTransfer.table.getValueAt(i,0).toString();
      ItemDesc = frmMain.pnlTransfer.table.getValueAt(i,2).toString();
      quantity = Integer.parseInt(frmMain.pnlTransfer.table.getValueAt(i,3).toString());
      rs = null;
...
//    String storeID = frmMain.pnlTransfer.txtSrcStoreID.getText();
    String toStoreID = frmMain.pnlTransfer.cboDesStoreID.getSelectedItem().toString();
    String creater = frmMain.pnlTransfer.txtCreaterName.getText();
    String receiver = frmMain.pnlTransfer.txtReceiverName.getText();
    String Trans_ID = frmMain.pnlTransfer.txtTransferID.getText();
