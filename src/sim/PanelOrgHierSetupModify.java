 ...
 */
//not use now
public class PanelOrgHierSetupModify extends JPanel {
  DataAccessLayer DAL;

  Utils ut = new Utils();
  ObjHierType orgHier=new ObjHierType();
   ...
   * @return		no
   */
  public PanelOrgHierSetupModify(FrameMainSim frmMain, CardLayout crdLayout, JPanel parent) {
    try {
...
//    };
    ...
    txtName.addKeyListener(new PanelOrgHierSetupModify_txtName_keyAdapter(this));
    ...
    txtDesc.setBounds(new Rectangle(5, 66, 240, 21));
        txtDesc.addKeyListener(new PanelOrgHierSetupModify_txtDesc_keyAdapter(this));
    jPanel6.setMinimumSize(new Dimension(38, 31));
    jPanel6.setPreferredSize(new Dimension(60, 31));
    jPanel6.setLayout(null);
    jPanel2.setLayout(null);
    flowLayout2.setAlignment(FlowLayout.LEFT);
    btnPrdHierTypeDone.addActionListener(new PanelOrgHierSetupModify_btnPrdHierTypeDone_actionAdapter(this));
    ...
    btnPrdHierTypeDone.setSelected(false);
    btnPrdHierTypeCancel.setToolTipText("Cancel (F3)");
    table.addKeyListener(new PanelOrgHierSetupModify_table_keyAdapter(this));
    ...
    btnPrdHierTypeModify.addActionListener(new PanelOrgHierSetupModify_btnPrdHierTypeModify_actionAdapter(this));
    btnPrdHierTypeCancel.addActionListener(new PanelOrgHierSetupModify_btnPrdHierTypeCancel_actionAdapter(this));
    table.addMouseListener(new PanelOrgHierSetupModify_table_mouseAdapter(this));
...
//define for table
  ...
  void btnPrdHierTypeCancel_actionPerformed(ActionEvent e) {
      frmMain.showScreen(Constant.SCRS_ORG_HIER_TYPE_SEARCH);
  }
  ...
  void btnPrdHierTypeModify_actionPerformed(ActionEvent e) {
    ...
    vSql.addElement("update BTM_IM_ORG_HIR_TYPE set NAME='" + name + "', DESCRIPTION = '" + desc + "' where TYPE_ID = '" + typeId + "'");
  ...
  private void createComboParent(){
   ...
   sSQL = "select TYPE_ID, HIGHER_TYPE_ID, NAME, DESCRIPTION from BTM_IM_ORG_HIR_TYPE order by TYPE_ID";
//   System.out.println(sSQL);
 ...
 private void addComboParent(Object o) {
   ...
   void showData() {
     ResultSet rs = null;
     try{
       String sSQL = "select TYPE_ID, HIGHER_TYPE_ID, NAME, DESCRIPTION from BTM_IM_ORG_HIR_TYPE where TYPE_ID ='" + typeId + "'";
//       System.out.println(sSQL);
       rs = DAL.executeQueries(sSQL);
       if (rs.next()){
...
class PanelOrgHierSetupModify_btnPrdHierTypeCancel_actionAdapter implements java.awt.event.ActionListener {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_btnPrdHierTypeCancel_actionAdapter(PanelOrgHierSetupModify adaptee) {
...
class PanelOrgHierSetupModify_btnPrdHierTypeModify_actionAdapter implements java.awt.event.ActionListener {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_btnPrdHierTypeModify_actionAdapter(PanelOrgHierSetupModify adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class PanelOrgHierSetupModify_txtName_keyAdapter extends java.awt.event.KeyAdapter {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_txtName_keyAdapter(PanelOrgHierSetupModify adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelOrgHierSetupModify_table_mouseAdapter extends java.awt.event.MouseAdapter {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_table_mouseAdapter(PanelOrgHierSetupModify adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelOrgHierSetupModify_btnPrdHierTypeDone_actionAdapter implements java.awt.event.ActionListener {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_btnPrdHierTypeDone_actionAdapter(PanelOrgHierSetupModify adaptee) {
    this.adaptee = adaptee;
  }
  public void actionPerformed(ActionEvent e) {
...
class PanelOrgHierSetupModify_txtDesc_keyAdapter extends java.awt.event.KeyAdapter {
    PanelOrgHierSetupModify adaptee;

    PanelOrgHierSetupModify_txtDesc_keyAdapter(PanelOrgHierSetupModify adaptee) {
        this.adaptee = adaptee;
    }
    public void keyTyped(KeyEvent e) {
...
class PanelOrgHierSetupModify_table_keyAdapter extends java.awt.event.KeyAdapter {
  PanelOrgHierSetupModify adaptee;

  PanelOrgHierSetupModify_table_keyAdapter(PanelOrgHierSetupModify adaptee) {
    this.adaptee = adaptee;
  }
