...
public class PanelPrintViewTransferSIM implements Printable{
  ////////////////////////////////////////////
  ...
  public PanelPrintViewTransferSIM(FrameMainSim frmMain) {
...
//System.out.println("VC " + vc.size());
    ...
    int quantity=0;
    ResultSet rs = null;
//    System.out.println("pnlTransferViewDetail table " + frmMain.pnlTransferViewDetail.table.getRowCount());
    for (int i = 0; i < frmMain.pnlTransferViewDetail.table.getRowCount(); i++) {
      ArtNo = frmMain.pnlTransferViewDetail.table.getValueAt(i,1).toString();
      ItemID = frmMain.pnlTransferViewDetail.table.getValueAt(i,0).toString();
      ItemDesc = frmMain.pnlTransferViewDetail.table.getValueAt(i,2).toString();
      quantity = Integer.parseInt(frmMain.pnlTransferViewDetail.table.getValueAt(i,4).toString());
      rs = null;
      String sql = "select  item_id, new_price, attr1_name, attr2_name from btm_im_price_hist " +
...
//      System.out.println(sql);
  ...
  public int print(Graphics g, PageFormat pageFormat,
    ...
    String storeID = frmMain.pnlTransferViewDetail.cboSourceStoreID.getSelectedItem().toString();
    String toStoreID = frmMain.pnlTransferViewDetail.cboDesStoreID.getSelectedItem().toString();
    String creater = frmMain.pnlTransferViewDetail.txtCreaterName.getText();
    String receiver = frmMain.pnlTransferViewDetail.txtReceiverName.getText();
    String Trans_ID = frmMain.pnlTransferViewDetail.txtTransferID.getText();
//    System.out.println("Store ID: transfer"+storeID);
    String store_name = DAL.getStoreName();
    String  datelable= frmMain.pnlTransferViewDetail.txtTransferDate.getText();
...
//    g2.drawString("STOREMEN 2:",200,620);
    g2.drawString("RECEIVER:",380,620);
...
//    System.out.println("abc:" + headerHeightOnPage);
    ...
    g2.drawString("CREATER:"+creater,230,80);
    g2.drawString("RECEIVER:"+receiver,230,100);
    g2.drawString("TRAN ID:"+ Trans_ID,490,80);
    g2.drawString("To STORE:"+toStoreID ,490,100);
    g2.setFont(f);
    g2.drawString("TRANSFER ON DATE "+ datelable.substring(0,10),250,50);
    //paint header at top
