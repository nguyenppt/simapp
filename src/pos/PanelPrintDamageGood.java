...
public class PanelPrintDamageGood implements Printable{
  ...
  public PanelPrintDamageGood(FrameMain frmMain) {
...
//    System.out.println("abc:" + headerHeightOnPage);
    ...
    g2.drawString("DGC:",450,100);
    g2.setFont(f);
    g2.drawString("DAMAGED GOOD RECEIVE",300,50);
    //paint header at top
