...
public class PanelReturnNotFoundItem
    extends JPanel {
...
//  int rowCount = 0;
  ...
  public PanelReturnNotFoundItem(FrameMain frmMain) {
    try {
  ...
  void jbInit() throws Exception {
    ...
    btnOK.addActionListener(new PanelReturnNotFoundItem_btnOK_actionAdapter(this));
    ...
    "sp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;F12</html>");
    btnBack.addActionListener(new PanelReturnNotFoundItem_btnBack_actionAdapter(this));
    ...
    btnSelectAll.addActionListener(new
                                   PanelReturnNotFoundItem_btnSelectAll_actionAdapter(this));
    ...
    btnClearAll.addActionListener(new PanelReturnNotFoundItem_btnClearAll_actionAdapter(this));
    ...
    btnReturnOK.addActionListener(new PanelReturnNotFoundItem_btnReturnOK_actionAdapter(this));
    ...
    btnReturnCancel.addActionListener(new
        PanelReturnNotFoundItem_btnReturnCancel_actionAdapter(this));
    ...
    comReason.addActionListener(new PanelReturnNotFoundItem_comReason_actionAdapter(this));
...
//          unit_qty= ut.convertToDouble(this.getValueAt(row, COL_QUANTITY).toString());
//          unit_price=ut.convertToDouble(this.getValueAt(row, COL_PRICE).toString());
//          markdown= ut.convertToDouble(this.getValueAt(row, COL_MARKDOWN).toString());
//          this.setValueAt(String.valueOf(unit_qty*(unit_price-markdown)),row, COL_AMOUNT);
//        }
      ...
      public boolean isCellEditable(int row, int col) {
        ...
        if (col == COL_QUANTITY || col==COL_MARKDOWN || col==COL_PRICE ) {
...
//    jTable2.setRowHeight(30);
    jTable2.addMouseListener(new PanelReturnNotFoundItem_jTable2_mouseAdapter(this));
...
//  void showData11(String trans_id) {
//    ResultSet rs = null;
//    try {
//      String sql = "select ITEM_ID,STORE_ID,ITEM_DESC, UNIT_PRICE, FLAG, UOM, ATTR1_NAME, ATTR2_NAME, ITEM_PRICE_DATE, ART_NO, CATEGORY, SUPP_ID, UNIT_COST, VAT " +
//          " from BTM_POS_ITEM_PRICE itm" +
//          " where itm.art_no = '" + trans_id +   "'";
...
//          "')";
      ...
      for (int i = 0; i < vItem.size(); i++) {
        listItem+="'"+String.valueOf(vItem.elementAt(i))+"',";
      }
      listItem=listItem.substring(0,listItem.length()-1);
//System.out.println("----"+ listItem);
//      txtTransID.setText("11111");
      String sql = "select ITEM_ID,ART_NO,ITEM_DESC,ATTR2_NAME,1, UNIT_PRICE,0 " +
          " from BTM_POS_ITEM_PRICE itm" +
          " where itm.art_no in (" + listItem +   ")";
...
//      else if ( Double.parseDouble(unit_qty1) < 0) {
      if ( Double.parseDouble(unit_qty1) < 0) {
...
//            getOldData(transID, item_id);
            ...
            double unit_qty1 = -Double.parseDouble("" + jTable2.getValueAt(i, COL_QUANTITY));
             ...
             org_unit_price =ut.convertToDouble("" + jTable2.getValueAt(i, COL_PRICE));
             tender_id = 1;
             promo_id = 0;
             store_id = DAL.getStoreID();
             cust_id = "-1";
             register_id = DAL.getregisterID();
//             amount = ut.convertToDouble("" + jTable2.getValueAt(i, COL_AMOUNT));
//             unit_qty = rs.getDouble("unit_qty");
             trans_date = ut.getSystemDate_ToDate();
             trans_datetime = ut.getSystemDateTime1();
             disc_amt = ut.convertToDouble("" + jTable2.getValueAt(i, COL_MARKDOWN));
             trans_type_id = "1";
             markdown = ut.convertToDouble("" + jTable2.getValueAt(i, COL_MARKDOWN));
             mkdn_disc_reason = "";
...
//                    frmMain.getTransaction().getEmpl_ID() +
                ...
                ",'" + trans_type_id + "'," + markdown + ",'" +
                mkdn_disc_reason +
                "'," + org_unit_price + ",'" + account_no + "',to_date('7777-7-7','YYYY-MM-DD'),1,0,'',to_date('7777-7-7','YYYY-MM-DD'),'-1')"
                );
  ...
  void txtMainInput_keyPressed(KeyEvent e) {
    ...
    if (e.getKeyCode() == KeyEvent.VK_ENTER) {
      if (flagButton == RI_OK_BTN) {
        if (mainInput.equals("")) {
          ut.showMessage(frmMain, lang.getString("TT001"),lang.getString("MS023_EnterItem"));
          return;
...
class PanelReturnNotFoundItem_jTable2_mouseAdapter
    extends java.awt.event.MouseAdapter {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_jTable2_mouseAdapter(PanelReturnNotFoundItem adaptee) {
...
class PanelReturnNotFoundItem_btnOK_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnOK_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_btnBack_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnBack_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_btnSelectAll_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnSelectAll_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_btnClearAll_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnClearAll_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_btnReturnOK_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnReturnOK_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_btnReturnCancel_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_btnReturnCancel_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
...
class PanelReturnNotFoundItem_comReason_actionAdapter
    implements java.awt.event.ActionListener {
  PanelReturnNotFoundItem adaptee;

  PanelReturnNotFoundItem_comReason_actionAdapter(PanelReturnNotFoundItem adaptee) {
    this.adaptee = adaptee;
  }
